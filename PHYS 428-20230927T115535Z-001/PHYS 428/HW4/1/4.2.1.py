...
def jacobi(A,b):
    ...
    xk0 = np.zeros((3,1))
    #initialize array to store x values at each iteration, to be plotted later
    xAtk1 = np.zeros
...
print('The solution x from the accelerated Gauss-Seidel iterative method is approximately...')
print(gssSdlAccel(A,b,w))
